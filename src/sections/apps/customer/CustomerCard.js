    ...
    <>
      <MainCard sx={{ height: 1, '& .MuiCardContent-root': { height: 1, display: 'flex', flexDirection: 'column' } }}>
        <Grid id="print" container spacing={2.25}>
          ...
          <Grid item xs={12}>
            <Typography>Hello, {customer?.description}</Typography>
          </Grid>
          <Grid item xs={12}>
          ...
          {/*      /!*  </ListItem>*!/*/}
          {/*      /!*))}*!/*/}
          {/*      {StatusCell(customer.accountStatus)}*/}
          {/*    </Box>*/}
          {/*  </Box>*/}
          {/*</Grid>*/}
        </Grid>
        ...
        >
          <Typography variant="caption" color="secondary">
            Created at {format(parseISO(customer.created), "M/d/yyyy")}
          </Typography>
      ...
      <AlertCustomerDelete title={customer.name} customerId={customer._id} open={openAlert} handleClose={handleAlertClose} />
    </>
  );
};
